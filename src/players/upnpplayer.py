...
class UpnpPlayer:
    ...
    def __init__(self, app, state_changed, audio_changed):
        self.transcode = True  #NOTE: Set to True to enable transcoding
    ...
    def ask_transport(self):
        ...
        if TransportInfo['CurrentTransportState'] == "STOPPED":
            self.state = "stopped"
            if self.Has_Next_AVTransport == False:
                #TODO: Implémenter le passage à la chanson suivante si Pas de NextAvTransport ...
                pass
