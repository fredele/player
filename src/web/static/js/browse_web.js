var uan1 = navigator.userAgent.toLowerCase();

if (uan1.includes("mobi") || uan1.includes("android") || uan1.includes("iphone") || uan1.includes("ipad")) {
    console.log("Chargé sur un appareil mobile (souvent Android si 'android' est présent)");
    var uap = "mobi"
} else {
    console.log("Chargé sur PC (desktop)");
    var uap = "desk"
}
